...
<form class="modal_checkout_coupon woocommerce-form-coupon" method="post">
	...
	<p>
		...
		<button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'newspack-blocks' ); ?>"><?php esc_html_e( 'Apply', 'newspack-blocks' ); ?></button>
	</p>
	<div class="clear"></div>
</form>

	...
	return (
		<Dropdown
						...
						controls={ [
							{
								...
								className: 'wp-block-newspack-blocks-google-ad-manager__format-picker-icon',
							},
						] }
					/>
				);
			...
			renderContent={ ( { onClose } ) => (
				<NavigableMenu className="wp-block-newspack-blocks-google-ad-manager__format-picker">

					...
					<?php foreach ( $frequencies as $frequency_slug => $frequency_name ): ?>
						...
						<div class='newspack-blocks-donate__frequency'>
							...
							<div class='input-container'>
								<label class='donate-label' for='newspack-<?php echo $esc_slug ?>-untiered-input'><?php echo esc_html__( 'Donation amount', 'newspack' ); ?></label>
								...
								<div class='newspack-blocks-donate__tiers'>
									<?php foreach ( $suggested_amounts as $index => $suggested_amount ): ?>
										<div class='newspack-blocks-donate__tier'>
											...
											<label class='tier-select-label' for='newspack-tier-<?php echo $esc_slug ?>-<?php echo (int) $index ?>'><?php echo esc_html( $settings['currencySymbol'] . $amount ); ?></label>
										</div>
									<?php endforeach; ?>

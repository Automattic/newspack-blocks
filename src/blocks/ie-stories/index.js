...
export const title = __( 'IE Stories', 'newspack-blocks' );
...
export const settings = {
	...
	styles: [
		...
		{ name: 'card', label: _x( 'Card', 'block style', 'newspack-blocks' ) },
		{ name: 'opinion', label: _x( 'Opinion', 'block style', 'newspack-blocks' ) },
	],
	supports: {
		html: false,
		align: [ 'wide', 'full' ],

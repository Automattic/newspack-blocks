...
add_filter(
	...
	function( $patterns, $post_type ) {
		if ( in_array( $post_type, [ 'page' ], true ) ) {
			$from_json = json_decode( file_get_contents( NEWSPACK_BLOCKS__PLUGIN_DIR . 'src/patterns/markup/homepage-posts/style-16.json'), true ); //phpcs:ignore
			$patterns[] = [
				'category' => __( 'Homepage Posts', 'newspack-blocks' ),
				'content'  => $from_json['content'],
...
add_filter(
	...
	function( $patterns, $post_type ) {
		if ( in_array( $post_type, [ 'page' ], true ) ) {
			$from_json = json_decode( file_get_contents( NEWSPACK_BLOCKS__PLUGIN_DIR . 'src/patterns/markup/homepage-posts/style-17.json'), true ); //phpcs:ignore
			$patterns[] = [
				'category' => __( 'Homepage Posts', 'newspack-blocks' ),
				'content'  => $from_json['content'],
...
add_filter(
	...
	function( $patterns, $post_type ) {
		if ( in_array( $post_type, [ 'page' ], true ) ) {
			$from_json = json_decode( file_get_contents( NEWSPACK_BLOCKS__PLUGIN_DIR . 'src/patterns/markup/homepage-posts/style-18.json'), true ); //phpcs:ignore
			$patterns[] = [
				'category' => __( 'Homepage Posts', 'newspack-blocks' ),
				'content'  => $from_json['content'],
...
add_filter(
	...
	function( $patterns, $post_type ) {
		if ( in_array( $post_type, [ 'page' ], true ) ) {
			$from_json = json_decode( file_get_contents( NEWSPACK_BLOCKS__PLUGIN_DIR . 'src/patterns/markup/homepage-posts/style-19.json'), true ); //phpcs:ignore
			$patterns[] = [
				'category' => __( 'Homepage Posts', 'newspack-blocks' ),
				'content'  => $from_json['content'],
...
add_filter(
	...
	function( $patterns, $post_type ) {
		if ( in_array( $post_type, [ 'page' ], true ) ) {
			$from_json = json_decode( file_get_contents( NEWSPACK_BLOCKS__PLUGIN_DIR . 'src/patterns/markup/homepage-posts/style-20.json'), true ); //phpcs:ignore
			$patterns[] = [
				'category' => __( 'Homepage Posts', 'newspack-blocks' ),
				'content'  => $from_json['content'],
